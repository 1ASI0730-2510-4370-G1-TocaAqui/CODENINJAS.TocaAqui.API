...
namespace CODENINJAS.TocaAqui.API.Migrations
{
    ...
    [Migration("20250704061828_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CODENINJAS.TocaAqui.API.Payments.Domain.Model.Aggregates.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CODENINJAS.TocaAqui.API.Payments.Domain.Model.Entities.PaymentStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("PaymentId")
                        .HasDatabaseName("ix_payment_status_history_payment_id");
            ...
            modelBuilder.Entity("CODENINJAS.TocaAqui.API.Payments.Domain.Model.Entities.PaymentStatusHistory", b =>
                {
                    b.HasOne("CODENINJAS.TocaAqui.API.Payments.Domain.Model.Aggregates.Payment", null)
                        .WithMany("StatusHistory")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_payment_status_history_payment_payment_id");
                });
