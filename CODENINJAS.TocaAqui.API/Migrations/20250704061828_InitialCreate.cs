        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bank_account_number = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    bank_name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    bank_account_type = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    currency = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false, defaultValue: "PEN"),
                    description = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_payment_status_history_payment_payment_id",
