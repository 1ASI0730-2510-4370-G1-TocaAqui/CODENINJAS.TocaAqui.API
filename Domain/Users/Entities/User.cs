...
public class User
{
    ...
    public ImageUrl Image { get; private set; } = default!;
    ...
    private User() { } // Para EF Core / deserialización
    ...
    public static User CreateMusico(
        ...
        ArtistType type,
        string description) =>
        new(name, email, passwordHash, Role.Musico, image, genre, type, description);
    ...
    public static User CreatePromotor(
        ...
        PasswordHash passwordHash,
        ImageUrl image) =>
        new(name, email, passwordHash, Role.Promotor, image, null, null, null);
}
